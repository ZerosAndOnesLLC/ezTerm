    ...
    *app_state.vault.write().await = initial_state;
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::credentials::credential_list_detailed,
            ...
            commands::vault::vault_recovery_status,
            commands::vault::vault_generate_recovery_code,
            ...
            commands::sftp::sftp_upload_begin,
            ...
            commands::local::local_shells_autodetect_seed,
            commands::local::list_local_shells,
            commands::local::platform,
